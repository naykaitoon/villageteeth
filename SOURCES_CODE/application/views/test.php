...
<meta name="description" content="ระบบจัดการ ทัตสุขภาพเด็ก โรงพยาบาลสมเด็จพระยุพราชเด่นชัย จังหวัดแพร่ จัดการข้อมูลสถิติ ทัตสุขภาพเด็ก โรงพยาบาลสมเด็จพระยุพราชเด่นชัย จังหวัดแพร่" />
  ...
  <script src="//code.jquery.com/ui/1.11.2/jquery-ui.js"></script>
	 ...
	 $(document).ready(function(){
                ...
                $('.content').fadeOut("fast").hide().load( '<?php echo base_url();?>index.php/boss/chillentInArea' ).fadeIn('fast');
				 $(".submenu , .submenusub").click(function(event) {
	 				 event.preventDefault();
                var href = $(this).attr('href');

                $('.content').fadeOut().hide().load( href ).fadeIn();
...
<ul class="dropdown">
      <li>
        ...
        <ul>
          <li><a class="submenu" href="<?php echo base_url();?>index.php/boss/chillentInArea"><p>- เด็กในเขตความรับผิดชอบของฉัน</p></a></li>
          <li><a class="submenu" href="">- เด็กทั้งหมด</a></li>
