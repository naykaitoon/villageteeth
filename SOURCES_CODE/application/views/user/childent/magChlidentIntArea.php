		...
		$(document).ready(function(){
			 ...
			 $(".searchBox").keyup(function(event){
				   event.preventDefault();
				    if($("#searchBox").val()!=""){
        		 $.post( 
             "<?php echo base_url();?>index.php/officials/childentInAreaSearch",
             { key: $("#searchBox").val() },
             function(data) {
			 ...
			 $('.content').load("<?php echo base_url();?>index.php/officials/childentInArea");
		  }
...
<br>
  ...
  <a href="<?php echo base_url();?>index.php/officials/addChillentInArea" class="fancyboxMagChildent" style="font-size:12px"><img src="<?php echo base_url();?>img/icon/addChilldent.png" width="40px" height="40px" class="iconAction"/>
...
echo $date->format('d-m-Y');
      ...
      <td align="center" valign="middle" nowrap="nowrap" style="font-size: 12px"><a href="<?php echo base_url();?>index.php/officials/editChildentInArea/<?php echo $c['childrenId'];?>" class="fancyboxMagChildent">
      <img class="iconAction" src="<?php echo base_url();?>img/editIcon.png" width="25px" height="25px"  style="margin-bottom:-8px;">
      </a></td>
      <td align="center" valign="middle" nowrap="nowrap" style="font-size: 12px"><a href="<?php echo base_url();?>index.php/officials/deleteChildentData/<?php echo $c['childrenId'];?>/<?php echo $c['addressId'];?>" class="deletechildentInArea">
