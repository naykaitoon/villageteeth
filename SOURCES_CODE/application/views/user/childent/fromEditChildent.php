		 ...
		 $( "#province" ).click(function() {
				var str = "";
					$( "select#province option:selected" ).each(function() {
						...
						$.post("<?php echo base_url()?>index.php/officials/getDistrict",
						  {
							provinceId:str
						  },
						  function(data){
		 ...
		 $( "#district" ).click(function() {
				var str = "";
					$( "select#district option:selected" ).each(function() {
						...
						$.post("<?php echo base_url()?>index.php/officials/getCanton",
						  {
							districtId:str
						  },
						  function(data){
			...
			.change(function() {
				var str = "";
					$( "select#canton option:selected" ).each(function() {
						...
						$.post("<?php echo base_url()?>index.php/officials/getZipCode",
						  {
							cantonId:str
						  },
						  function(data){
...
<form id="form1" action="<?php echo base_url();?>index.php/officials/editActionChildent" name="form1" method="post" onsubmit="return checkFormSubmit();">
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
      ...
      <tr>
        <td width="33%" align="right" valign="middle">ชื่อ - นามสกุล : <input type="hidden" name="childrenId" id="childrenId" value="<?php echo $childent[0]['childrenId'];?>"><input type="hidden" name="addressId" id="addressId" value="<?php echo $childent[0]['addressId'];?>"></td>
        <td width="67%" align="left" valign="middle"><input type="text" name="childrenName" id="childrenName" value="<?php echo $childent[0]['childrenName'];?>"> - <input type="text" name="childrenLastName" id="childrenLastName"  value="<?php echo $childent[0]['childrenLastName'];?>"></td>
      </tr>
      <tr>
