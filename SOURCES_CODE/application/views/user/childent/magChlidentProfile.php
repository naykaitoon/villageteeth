		...
		$(document).ready(function(){
			$(".searchBox").focus();
			 $(".searchBox").keyup(function(event){
				   ...
				   if($("#searchBox").val()!=""){
        		 $.post( 
             "<?php echo base_url();?>index.php/officials/childentAllProfileSearch",
             { key: $("#searchBox").val() },
             function(data) {
...
<br>
  ...
  <a href="<?php echo base_url();?>index.php/officials/addChillent" class="fancybox" style="font-size:12px"><img src="<?php echo base_url();?>img/icon/addChilldent.png" width="40px" height="40px" class="iconAction"/>
  เพิ่มข้อมูลเด็ก</a>
...
echo $date->format('d-m-Y');
	  ?></p></td>
      <td align="center" valign="middle" nowrap="nowrap" style="font-size: 12px"><a href="<?php echo base_url();?>index.php/officials/childentAddress/<?php echo $c['childrenId'];?>" class="fancybox">
