	   ...
	   showOn: "button",
		...
		buttonText: "เลือกวันที่"
			...
			$("#submit").click(function(event){
				  ...
				  $.post( "<?php echo base_url();?>index.php/officials/addPolicing", 
			  ...
			  $('#cancle').click(function(event){
				  event.preventDefault();
					$('.content').load('<?php echo base_url();?>index.php/officials/police');	
...
<form class="addPolicing" action="<?php echo base_url();?>index.php/officials/addPolicing" method="post" >
...
$roop = 0;
 ...
 $roop++;
   ...
   if(!$polincyPhoto){
    ...
    <a class="policingPhoto" href="<?php echo base_url();?>index.php/officials/policingPhoto/<?php echo $b['behaviorId']; ?>/<?php echo $childent[0]['childrenId']; ?>"><?php echo $text;?></a>
       </td>
