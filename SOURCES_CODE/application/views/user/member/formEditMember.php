...
<script type="text/javascript">
	...
	$( "#memberUsername" ).click(function() {
		 if($(this).val()!=""){
		$.post("<?php echo base_url()?>index.php/officials/checkUserName",
						  {
							username:$(this).val()
						  },
						  function(data){
...
<form id="form1" action="<?php echo base_url();?>index.php/officials/editActionMember" name="form1" method="post" onsubmit="return checkFormSubmit();" >
