		 ...
		 $( "#canton" ).change(function() {
				...
				var provinceId = 0;
					$( "select#canton option:selected" ).each(function() {
						...
						$.post("<?php echo base_url()?>index.php/officials/memberByAreaSearch",
						  {
							cantonId:cantonId,
...
<br>
  ...
  <?php }?>
   ...
   <a href="<?php echo base_url();?>index.php/officials/addMember" class="AddMember" style="font-size:12px"><img src="<?php echo base_url();?>img/icon/addMember.png" width="40px" height="40px"/>เพิ่มข้อมูลผู้ใช้งาน</a></p>
