...
if($_GET['print']==1){?>
<a class="popupPrint" href="<?php echo base_url();?>index.php/report/myChartsPolicingsReportPrint" ><img src="<?php echo base_url();?>img/printicon.png" width="50px;"/>พิมพ์</a>
<?php }?>
