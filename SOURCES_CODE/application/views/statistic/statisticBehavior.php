...
<?php 
		$all = '<a href="'.base_url().'index.php/report/chartsBehaviorReport" class="year">ทั้งหมด</a>|';
		echo $all;
	foreach($year as $y){
		$yea = date('Y', strtotime($y['policingDate']));
		$link = '<a href="'.base_url().'index.php/report/chartsBehaviorReport/'.
		$yea
		.'" class="year">'.$yea.'</a> |';
	echo $link;
	}
...
<iframe src="<?php echo base_url();?>index.php/report/chartsBehaviorReport" scrolling="auto"></iframe><br><br>
<br>
