...
<div id="headTitleContentbg">
 ...
 <p style="margin-top:16px;"><a class="addBehavior" style="font-size:12px" href="<?php echo base_url();?>index.php/boss/addBehavior"><img src="<?php echo base_url()?>img/icon/behaviorIconAdd.png" width="40px" class="iconAction"/>เพิ่มข้อมูลพฤติกรรมทัตสุขภาพ</a></p>
