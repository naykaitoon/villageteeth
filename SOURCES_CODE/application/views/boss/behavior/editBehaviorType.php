...
<form action="<?php echo base_url();?>index.php/boss/editBehaviorMagTypeAction" method="post">
 ...
 <tr>   
    <th colspan="2" align="center" valign="baseline" nowrap="nowrap" ><p>แก้ไขข้อมูลหมวดหมู่พฤติกรรมทัตสุขภาพ</p></th>
   	</tr>

    <tr>    
           <td width="61" align="center" valign="middle" nowrap="nowrap" ><p>ชื่อหมวดหมู่</p></td>  
       <td width="158" align="center" valign="middle" nowrap="nowrap" ><p><input name="behaviorTypeName"  type="text"  required id="behaviorTypeName" value="<?php echo $d['behaviorTypeName'];?>" size="50" ><input  type="hidden" name="behaviorTypeId" id="behaviorTypeId" value="<?php echo $d['behaviorTypeId'];?>"  required ></p></td>   
    </tr>
      <tr>    
