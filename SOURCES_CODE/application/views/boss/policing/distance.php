...
<div id="headTitleContentbg">
 ...
 <p style="margin-top:16px;"><a class="fancyboxMini" style="font-size:12px" href="<?php echo base_url();?>index.php/boss/addDistance"><img src="<?php echo base_url()?>img/icon/distanceIconAdd.png" width="40px" class="iconAction"/>เพิ่มช่วงอายุ</a></p>
