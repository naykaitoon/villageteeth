       ...
       <tbody>
         ...
         <tr>
           <td colspan="2" align="center" valign="middle" nowrap="nowrap"><a href="<?php echo base_url();?>index.php/home/loginForm" id="loginForm" class="loginFormButtom">กลับ</a>&nbsp;&nbsp;<input class="loginFormButtom" type="button" value="ยืนยัน"></td>
         </tr>
           <tr>
